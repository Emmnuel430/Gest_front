    ...
    if (resultat.libelle) {
      const filtered = etudiants.filter((e) => {
        if (resultat.libelle === "code") {
          // Sélectionner uniquement les étudiants en cours ou examen de code
          return (
            e.progression?.etape === "cours_de_code" ||
            e.progression?.etape === "examen_de_code"
          );
        } else if (resultat.libelle === "conduite") {
          // Sélectionner uniquement les étudiants en cours ou examen de conduite
          return (
      ...
      <ConfirmPopup
        ...
        body={
          <p>
            ...
            <strong>Libellé :</strong> {resultat.libelle} <br />
